    ...
    <footer className="bg-gradient-to-r from-blue-900 to-red-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 flex flex-row gap-3"> <Image src="/images/oz-lotto-logo.png" alt="OZ Lotto" width={30} height={30} className="h-12 w-auto" /> OZ Lotto</h3>
            <p className="text-white/90 text-sm">
              Australia's premier lottery experience since 1994. Play responsibly and dream big with us!
            </p>
            <p className="text-white/90 text-sm">
              For those seeking self-exclusion from all online gambling platforms, BetStop provides a free service as the National Self-Exclusion Register.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-white/90 text-sm">
              Please play responsibly. If you need help, contact Gambling Help Online or call 1800 858 858 or visit GambleAware online at <Link href="https://www.gambleaware.org/"><p  className="text-green/80 hover:text-blue transition-colors">www.gambleaware.org</p></Link>
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center text-sm text-white/80">
          <p>
            &copy; 2025 OZbigwinau. All rights reserved. Licensed and regulated by Australian gaming
            authorities.
          </p>
        </div>
      </div>
